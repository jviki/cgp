...
OBJ = cgp.o main.o chromo.o func_swap.o fitness_bits64.o fenotype64.o rndgen.o alap.o bitgen.o
...
fitness-tool: fitness-tool.o chromo.o fitness_bits64.o fenotype64.o func_gates.o rndgen.o alap.o bitgen.o
